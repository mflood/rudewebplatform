...
CommandError::CommandError(const char *filename, int linenumber, const char *message)
{
   setMessage( filename, linenumber, "system", "0001", "CommandFactory Error", message);
}

bool CommandError::execute()
{
	return false;
}
