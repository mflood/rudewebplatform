...
void ViewError::display(std::ostream &mystream)
{

}

ViewError::ViewError(const char *filename, int linenumber, const char *message)
{
   setMessage( filename, linenumber, "system", "0002", "ViewFactory Error", message);
